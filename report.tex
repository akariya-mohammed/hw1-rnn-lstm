...
\begin{tabular}{rl}
    ...
    \textbf{Students}   & Mohammad Akariya \quad 211862024 \\[4pt]
                        & Jude Khleif \quad\quad\ 325233633 \\[6pt]
...
% ─── 8. Expected Grade ───────────────────────────────────────────────────────
\section{Expected Grade}

We estimate our grade for this submission at \textbf{95\,/\,100}.

All required components are implemented and documented: dataset generation
with four frequencies, three core architectures (MLP, RNN, LSTM), MSE loss,
unit tests exceeding 150 lines, and a detailed lab report.
The two supplementary extensions --- bidirectional stacked models (BiRNN,
BiLSTM) and the combined signal extraction experiment --- go beyond the
minimum requirements and confirm the theoretical predictions from the
lectures.
The estimated 5-point deduction reflects that hyperparameter tuning was
not exhaustive and the combined experiment does not yet include BiRNN/BiLSTM
variants.
